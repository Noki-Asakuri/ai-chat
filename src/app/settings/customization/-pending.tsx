      ...
      <form className="space-y-6">
          ...
          <CardContent className="space-y-4">
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                <Input disabled className="bg-input/30" placeholder="Engineer, student, etc." />
              </div>
            </div>
        ...
        <Card className="rounded-md">
          ...
          <CardContent className="space-y-0">
            <div className="flex items-start justify-between gap-6 py-4">
              <div className="min-w-0 space-y-1">
                ...
                <p className="text-sm text-muted-foreground">
                  When enabled, use Enter for new lines, and Ctrl/Command + Enter to send messages.
                  When disabled, use Enter to send and Shift + Enter for new lines.
                </p>
              </div>
            ...
            <div className="flex items-start justify-between gap-6 py-4">
              <div className="min-w-0 space-y-1">
                <Label className="text-sm leading-none font-medium">Disable blur</Label>
                <p className="text-sm text-muted-foreground">
                  Turn off the blur effect on the chat background (can improve readability).
                </p>
              </div>
              <Skeleton className="h-[1.15rem] w-8 rounded-full" />
            </div>
