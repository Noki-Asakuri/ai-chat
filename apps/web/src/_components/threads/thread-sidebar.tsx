...
export function ThreadSidebar() {
  ...
  return (
    <Sidebar
      variant="inset"
      className="bg-background/80 backdrop-blur-md backdrop-saturate-150 group-data-[disable-blur=true]/sidebar-provider:bg-background"
    >
      <div className="pointer-events-none absolute inset-0 -z-5 group-data-[disable-blur=true]/sidebar-provider:hidden">
        <div className="h-1/2 w-full bg-linear-to-b from-background/80 from-5% to-transparent to-80%" />
        <div className="h-1/2 w-full bg-linear-to-t from-background/80 from-5% to-transparent to-80%" />
      </div>
