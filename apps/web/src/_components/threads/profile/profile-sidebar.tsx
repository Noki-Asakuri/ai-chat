...
export function ThreadProfileSidebar() {
  ...
  return (
    <div
      ...
      className="absolute top-12 right-0 z-50 flex h-[calc(100%-48px)] w-14 flex-col items-start gap-4 border-x border-b bg-sidebar/80 p-2 backdrop-blur-md backdrop-saturate-150 group-data-[disable-blur=true]/sidebar-provider:bg-sidebar"
    >
      {data.map((profile) => (
