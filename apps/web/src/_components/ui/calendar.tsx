/* eslint-disable react/no-unstable-nested-components -- DayPicker requires locale-bound component renderers. */
"use client";
...
function CalendarChevron({ className, orientation, ...props }: React.ComponentProps<typeof ChevronLeftIcon> & { orientation?: "left" | "right" | "up" | "down" }) {
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        weekday: cn(
          "flex-1 rounded-(--cell-radius) text-[calc(var(--custom-ui-font-size,16px)*0.8)] font-normal text-muted-foreground select-none",
          defaultClassNames.weekday,
        ),
        week: cn("mt-2 flex w-full", defaultClassNames.week),
        week_number_header: cn("w-(--cell-size) select-none", defaultClassNames.week_number_header),
        week_number: cn(
          "text-[calc(var(--custom-ui-font-size,16px)*0.8)] text-muted-foreground select-none",
