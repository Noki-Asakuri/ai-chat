...
function ToggleRow(props: ToggleRowProps) {
  ...
  return (
    <Item className="items-start rounded-none border-0 py-4 sm:flex-nowrap sm:items-center">
        ...
        >
          ...
          >
            <div className="flex items-center gap-2 text-left">
              <span>
                {props.sendPreference === "ctrlEnter" ? "Press Ctrl + Enter to send" : "Press Enter to send"}
              </span>
            </div>
          </SelectTrigger>
